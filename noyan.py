...
acil = PRANKBOTS.LINE() 
acil.login(token="EpRkknnnIT6UgDbftCdb.y/mysgImfTVfdN7W13HrcW.spzR41ZFqTrETZrVM0sQjGIauq7tVnM9tOHJs3CQ75Y=") 
acil.loginResult()

pb1 = PRANKBOTS.LINE() 
pb1.login(token="Ep4Rjuf2Tqwz7DOfVpra.wOew2Ph5nkkoV9ciPzxnoG.JLH+17cFFuC/0I6YxiqA/EbI/aP/UjZml6HRamHn28g=") 
pb1.loginResult()

pb2 = PRANKBOTS.LINE() 
pb2.login(token="Ep7QO3DUrU1fg2mVUC85.Wa9cwoGB0KRq73j1rEL8nq.K+pSeO6L6j/s+WMIPAkdqsRWZ75Zez5CTnKLIDIrNs4=") 
pb2.loginResult()
...
🔐 Procancel:on/off
╚══════════╝
[🚨A D M I N🚨= http://line.me/ti/p/~xnoyanx ]
"""
...
admsa = "u63e31848688c16dbc50e7ef0d778510b"
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"""❂•••• Eklediginiz için teşekürler 🏆B Y A D M I N 🏆••••❂""",
    "lang":"JP",
    "comment1":" 🔐 Auto Like ➡ A D M i N : http://line.me/ti/p/~xnoyanx ",
    "comment":"❗⭐⭐⭐⭐⭐⭐⭐❗",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u63e31848688c16dbc50e7ef0d778510b'}
                acil.sendMessage(msg)
...
#--------------------------------------------------------
                ...
                acil.sendText(msg.to,"❂•••••••••🔥N O Y A N I Z M ••••••••••❂")
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u63e31848688c16dbc50e7ef0d778510b'}
                acil.sendMessage(msg)
                acil.sendText(msg.to,"❂•••••⭐A D M I N ⭐•••••❂")
...
#	      if msg.from_ in admin:
		       ...
		       acil.sendText(msg.to,"Wating in progres...\n http://line.me/ti/p/~xnoyanx")
                       acil.sendText(g.mid,"http://line.me/ti/p/~xnoyanx")
                       pb1.sendText(g.mid," http://line.me/ti/p/~xnoyanx")
                       pb2.sendText(g.mid," http://line.me/ti/p/~xnoyanx")
                       acil.sendText(g.mid,"http://line.me/ti/p/~xnoyanx")
                       pb1.sendText(g.mid," http://line.me/ti/p/~xnoyanx")
                       pb2.sendText(g.mid,"http://line.me/ti/p/~xnoyanx")
                       pb1.sendText(g.mid," http://line.me/ti/p/~xnoyanx")
...
#---------------------- = NUKE = ------------------
                ...
                if msg.toType == 2:
                    ...
                    acil.sendText(msg.to," ❌B Y A D M I N ❌")
                    targets = []
                    for g in gs.members:
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ginfo = acil.getGroup(msg.to)
                    try:
                        acil.sendText(msg.to,"􀜁􀇔􏿿 ⭐A D M I N BY N O Y A N I Z M \n"  +  str(ginfo.name)  + "")
